<?php
/**
 * @package SimplePlugin\Admin\Settings
 */

namespace SimplePlugin\Admin\Settings;
...
class General extends AbstractPage
{
    ...
    public function settings()
    {
        ...
        register_setting( 'simple_plugin_general', 'simple_plugin_option', $option );
        ...
        register_setting( 'simple_plugin_general', 'simple_plugin_another_option', $another_option );
    }
    ...
    public function render()
    {
        ...
        <div class="wrap">
            ...
            <h1 class="wp-heading-inline"><?php esc_html_e( 'General Settings', 'simple-plugin' ); ?></h1>

            <form action="<?php echo esc_url( admin_url( 'options.php' ) ); ?>" method="post">

                <?php settings_fields( 'simple_plugin_general' ); ?>
    ...
    public function help()
    {
        ...
        $sidebar = '<p><strong>' . __( 'For more information:', 'simple-plugin' ) . '</strong></p>' .
